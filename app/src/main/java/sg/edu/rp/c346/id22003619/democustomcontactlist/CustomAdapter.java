package sg.edu.rp.c346.id22003619.democustomcontactlist;
...
public class CustomAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        String imgaeUrl="https://i.imgur.com/tGbaZCY.jpg";
        Picasso.with(parent_context).load(imgaeUrl).into(ivGender);
